...
(async () => {
  ...
  */
  ...
  console.log("Tree keypair", treeKeypair);
  ...
  */
  ...
  console.log("Collection Token Account:", collection.tokenAccount);
  console.log("Collection Metadata Account:", collection.metadataAccount);
  console.log("Collection Master Edition Account:", collection.masterEditionAccount);
